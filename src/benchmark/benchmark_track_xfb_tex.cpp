...
bool benchmark::benchmark_track_xfb_tex::checkSupport() noexcept {
	return benchmark_track_xfb::checkSupport() && texture::checkSupport();
}

benchmark::benchmark_track_xfb_tex::benchmark_track_xfb_tex() {
...
std::pair<double, benchmark::benchmark_base::doRMSE_return_t> benchmark::benchmark_track_xfb_tex::drawFrame() {
	generatePoints();
	clearResults();
