...
bool benchmark::benchmark_onehot_xfb_tex::checkSupport() noexcept {
	return benchmark_onehot_xfb::checkSupport() && texture::checkSupport();
}

benchmark::benchmark_onehot_xfb_tex::benchmark_onehot_xfb_tex() {
...
std::pair<double, benchmark::benchmark_base::doRMSE_return_t> benchmark::benchmark_onehot_xfb_tex::drawFrame() {
	generatePoints();
	clearResults();
